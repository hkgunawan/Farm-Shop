  ...
  <div class="row">
    ...
    <img 
      ...
      <input type="file" name="gambar" id="gambar">
            ...
            <textarea class="form-control" id="keterangan" name="keterangan" id="mytextarea" >{{$task->keterangan}}</textarea>
            </div>
            <div class="form-group">
        ...
        @foreach ($items as $item)
          <option value="{{$item->id_kategori}}" @if($item->id_kategori == $task->id_kategori)
              selected
        ...
        @endforeach
          ...
          <input type="text" readonly class="form-control" name="harga_average" id="harga_average" placeholder="harga_average"  value="{{$task->harga_average}}">
            </div>
              <div class="form-group">
